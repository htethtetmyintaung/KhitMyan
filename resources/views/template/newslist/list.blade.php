...
<section class="abouttitle padding-top-bottom">
    <div class="container">
        ...
        <div>
            <h2 class="text-align-center">{{$news->title_en}}</h2>
            <hr>
        </div>
            ...
            <div class="news-listpage mb-5">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    @foreach($categories as $category)
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link " id="pills-{{ $category->id }}-tab" data-bs-toggle="pill" data-bs-target="#pills-{{ $category->id }}" type="button" role="tab" aria-controls="pills-{{ $category->id }}" aria-selected="true">{{ $category->name_en }}</button>
                        </li>
                                        ...
                                        <div class="card-body">
                                            <a href="{{url('/news/'.$item->id)}}">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="category">{{$cate_item->name_en}}</span>
                                                    @endforeach
                                                    <span class="created-by">{{$item->creator_en}}</span><br>
