    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-12">
                ...
                <span>></span>
                <a href="{{url('/#service')}}"> <strong>Service</strong> </a> 
                <span>></span>
                <span>Vision</span>
            </div>
        ...
        <div>
            <div>
                <h2 class="text-align-center">{{$vision->title_en}}</h2>
                <hr>
            </div>
        ...
        <div>   
            ...
            $service = Service::get(['id', 'category_en']);
            foreach($service as $category)
            {
                foreach($clients as $client)
                if($category->id == $client->service_id)
                {
                    $category_title = $category->category_en;
                }
            }
            ...
            @foreach($clients as $client)
                <div class="col-lg-4 col-12 clients">
                    ...
                    <h6>{{$client->name_en}}</h6>
                    <p>{!! $client->description_en !!}</p>
