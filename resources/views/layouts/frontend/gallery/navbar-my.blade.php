<nav class="navbar navbar-expand-lg bg-white shadow-lg">
    <div class="container">
        ...
        <a href="{{url('/my')}}" class="navbar-brand"><img src="{{asset('assets/images/jmugroup-logo.png')}}" class="top-logo" alt="" srcset=""></a>
        ...
        <div class="collapse navbar-collapse navbar-position" id="navbarNav">    
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item" href="{{url('/gallery/'.$main_galleries->id)}}">English</a></li>
