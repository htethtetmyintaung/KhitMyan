<nav class="navbar navbar-expand-lg bg-white shadow-lg">
    <div class="container">
        ...
        <a href="{{url('/my')}}" class="navbar-brand"><img src="{{asset('assets/images/jmugroup-logo.png')}}" class="top-logo w-100" alt="" srcset=""></a>
        ...
        <div class="collapse navbar-collapse navbar-position" id="navbarNav">
            ...
            @foreach ($contents as $content)
                <li class="nav-item w-100">
                    ...
                    <a href="{{$content->link_my}}" class="nav-link click-scroll-no "  >{{ $content->title_my }}</a>
