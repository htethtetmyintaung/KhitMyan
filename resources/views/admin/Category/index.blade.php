        ...
        <div class='title-flex'>
            ...
            <div class="d-flex">
                ...
                <div class="search-item">
                    <form action="{{ url('admin/Category/index') }}" method="GET" class="d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                        <div class="input-group">
                            <a href="{{ url('admin/Category/index') }}" class="refresh-btn">
                ...
                @if($permission->checkPermission('Template create'))
                    <a href="{{ url('admin/Category/add-content') }}" class='btn btn-primary'><i class="fa-solid fa-square-plus"></i>ADD</a>
                @else
                ...
                <td>
                    <div class="d-flex justify-content-center">
                        <!-- @if($permission->checkPermission('Template view'))
                            <a href="{{ url('admin/Category/show-content/'.$content->id) }}" class="btn btn-success view"><i class="fa-solid fa-eye"></i></a>
                        @else
                        <a class="btn btn-success view"><i class="fas fa-exclamation-triangle"></i></a>
                        @endif    -->

                        @if($permission->checkPermission('Template edit'))
                            <a href="{{ url('admin/Category/edit-content/'.$content->id) }}" class="btn btn-success edit"><i class="fa-solid fa-pen-to-square"></i></a>
                        @else
                        <a class="btn btn-success edit"><i class="fas fa-exclamation-triangle"></i></a>
                        @endif  

                        @if($permission->checkPermission('Template delete'))
                            <form method="POST" action="{{ url('admin/Category/delete-content/'.$content->id) }}">
                                @csrf
                            ...
                            <!-- <a href="{{ url('admin/Category/delete-content/'.$content->id) }}" class="btn btn-danger delete"><i class="fa-solid fa-trash"></i></a> -->
                        @else
