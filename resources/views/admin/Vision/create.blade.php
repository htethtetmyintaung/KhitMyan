...
<div class="container-fluid px-4">
    <div class='title-flex'>
        ...
        <form action="{{ url('admin/Vision/add-content') }}" method="POST" enctype="multipart/form-data">
        @csrf
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="english" role="tabpanel" aria-labelledby="english-tab">
                    <h3>Vision (English Language)</h3>
                    <hr>
                    ...
                    <textarea name="description_en" id="vision_en_summernote" class="form-control" rows="4"></textarea>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="myanmar" role="tabpanel" aria-labelledby="myanmar-tab">
                    ...
                    <div class="form-group form-flex">
                    <label for="basicEmailInput">Description</label>
                    <textarea name="description_my" id="vision_my_summernote" class="form-control" rows="4"></textarea>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="japan" role="tabpanel" aria-labelledby="japan-tab">
                    ...
                    <div class="form-group form-flex">
                    <label for="basicEmailInput">Description</label>
                    <textarea name="description_ja" id="vision_ja_summernote" class="form-control" rows="4"></textarea>
                    </div>
                </div>                
            </div>
            <!-- Cover Image -->
