...
<div class="container-fluid px-4 mb-5">
        ...
        <form action="{{ url('admin/Galleries/add-content') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="english" role="tabpanel" aria-labelledby="english-tab">
                    ...
                    <input class="form-control" type="text" name="sub_title_en" id="basicEmailInput" placeholder="">
                    </div>
                    <div class="form-group form-flex">
                    <label for="basicEmailInput">Desciption</label>
                    <textarea name="description_en" id="galleries_en_summernote" class="form-control" rows="4"></textarea>
                    </div>
                </div>
                <div class="tab-pane fade" id="myanmar" role="tabpanel" aria-labelledby="myanmar-tab">
                    ...
                    <div class="form-group form-flex">
                    <label for="basicEmailInput">Sub Title</label>
                    <input class="form-control" type="text" name="sub_title_my" id="basicEmailInput" placeholder="">
                    </div>
                    <div class="form-group form-flex">
                    <label for="basicEmailInput">Desciption</label>
                    <textarea name="description_my" id="galleries_my_summernote" class="form-control" rows="4"></textarea>
                    </div>
                </div>
                <div class="tab-pane fade" id="japan" role="tabpanel" aria-labelledby="japan-tab">
                    ...
                    <div class="form-group form-flex">
                    <label for="basicEmailInput">Sub Title</label>
                    <input class="form-control" type="text" name="sub_title_ja" id="basicEmailInput" placeholder="">
                    </div>
                    <div class="form-group form-flex">
                    <label for="basicEmailInput">Desciption</label>
                    <textarea name="description_ja" id="galleries_ja_summernote" class="form-control" rows="4"></textarea>
                    </div>
                </div>
            </div>
