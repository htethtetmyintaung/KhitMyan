...
@section('content')
    ...
    <div class="container-fluid px-4">
        ...
        <form action="{{ url('admin/Roles/add-content') }}" method="POST" enctype="multipart/form-data">
        @csrf        
            <div class="form-group form-flex">
                <label for="basicEmailInput">Name</label>
                <input class="form-control" type="text" name="role" id="basicEmailInput" placeholder="">
            </div>
